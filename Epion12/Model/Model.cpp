...
namespace epion::Model
{
	...
	void ModelCore::DefaultSetPipeLine(com_ptr<ID3DBlob>& vs_blob, com_ptr<ID3DBlob>& ps_blob, com_ptr<ID3D12RootSignature>& root_sig)
	{
		m_pipeline_desc = {};
	...
	void Model3D::DefaultSetPipeLine(com_ptr<ID3DBlob>& vs_blob, com_ptr<ID3DBlob>& ps_blob,com_ptr<ID3D12RootSignature>& root_sig)
	{
		m_pipeline_desc = {};
		m_pipeline_desc.pRootSignature = nullptr;
	...
	bool Model3D::ShaderSet(com_ptr<ID3DBlob>& vs_blob, com_ptr<ID3DBlob>& ps_blob)
	{
